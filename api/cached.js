...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { summary, footnotes, headline, subheading, heading2, subheading2, heading3, subheading3, heading4, subheading4, columnHook, topImageUrl, comments, created_at } = doc.data();
    ...
    res.status(200).json({ summary, footnotes: footnotes || '', headline: headline || '', subheading: subheading || '', heading2: heading2 || '', subheading2: subheading2 || '', heading3: heading3 || '', subheading3: subheading3 || '', heading4: heading4 || '', subheading4: subheading4 || '', columnHook: columnHook || '', topImageUrl: topImageUrl || '', comments: comments || [], created_at, fresh });
  } catch(err) {
